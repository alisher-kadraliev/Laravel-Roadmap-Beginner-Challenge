   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ request()->routeIs('admin.tag') ? 'active' : '' }}">
                    <a href="{{route('admin.tag')}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-tag"></i>
                        <div data-i18n="Analytics">Tag</div>
                    </a>
                </li>
                <li class="menu-item mx-4 my-3">
                    <a href="{{route('home')}}" class="  btn btn-sm btn-outline-primary"><i class="bx bx-log-out-circle"></i> HomePage</a>
                </li>
